 ...
 * text-contrast bar.
 *
 * Desktop only: on phones WhatsApp lives in `MobileBookingBar`, beside Book A
 * Spot, rather than floating over it.
 */
export const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-[1000] hidden items-center gap-3 lg:flex rounded-full bg-[#25D366] px-5 py-4 text-white shadow-xlarge ring-1 ring-white/25 transition-transform duration-200 hover:scale-105 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:outline-none md:bottom-8 md:right-8"
    >
