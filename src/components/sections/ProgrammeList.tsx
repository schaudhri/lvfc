 ...
 * - `ProgrammeListRow` — the plainest form, for branch pages, where the
 *   branch's own pills already say what runs there.
 *
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-2 p-6 md:p-10">
        ...
        <h3 className="text-h4 font-medium text-brand-terracotta">
...
export const CompactProgrammeCard = ({ programme }: { programme: Programme }) => {
  ...
  return (
    <li className={cn("group flex flex-col gap-1", cardPadded)}>
      ...
      <p className="mt-3 mb-6 text-brand-midnight/90">{programme.summary}</p>
