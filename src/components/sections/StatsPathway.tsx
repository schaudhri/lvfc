  ...
  return (
    <section className="bg-neutral-darkest px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <h2 className="mb-12 text-center text-h2 font-bold text-white md:mb-18 lg:mb-20">{heading}</h2>

        {/* Stats panel — angled dividers between cells */}
        <div className="mx-auto max-w-4xl overflow-hidden bg-white">
        ...
        */}
        ...
        <div className="-mx-[5%] mt-10 overflow-x-auto px-[5%] md:mt-12 md:mx-0 md:px-0">
          <div className="mx-auto flex min-w-[30rem] max-w-4xl items-start justify-between px-2 md:min-w-0">
            {nodes.map((node, index) => (
              <div key={index} className="relative flex min-w-0 flex-1 flex-col items-center">
                ...
                <span className="relative z-10 flex size-3.5 items-center justify-center rounded-full bg-white">
